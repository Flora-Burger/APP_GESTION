"""Gestion des fichiers photo uploades pour les ordinateurs."""
...
DOSSIER_UPLOADS = RACINE_PROJET / "static" / "uploads" / "ordinateurs"
PREFIXE_URL_LOCALE = "/static/uploads/ordinateurs/"
...
async def enregistrer_photo_ordinateur(fichier: UploadFile) -> str:
